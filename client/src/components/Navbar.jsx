    ...
    return (
        <React.Fragment>
            <nav className="md:flex hidden justify-between">
                <div></div>
                <Link to={path}>
                    <div className="xl:text-3xl md:text-2xl text-4xl text-lime-500 font-bold p-6 font-eater md:mx-5 my-5">{children}</div>
                </Link>
            </nav>
            <nav className="flex md:hidden justify-between">
                <div></div>
                <Link to={path}>
                    <div className="text-lime-500 font-bold p-6 font-eater md:mx-5 md:my-5">{children}</div>
                </Link>
            </nav>
        </React.Fragment>
    );
