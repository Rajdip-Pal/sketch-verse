    ...
    return (
        ...
        <React.Fragment>
            ...
            <div className="flex flex-col md:hidden h-screen align-middle items-center justify-center">
                ...
                {/* About us button with link */}
                <Link to={'/aboutus'}>
                    <button className="px-10 py-2 my-5 font-kota text-xl rounded-3xl bg-lime-500 text-black hover:bg-green-700 hover:text-white active:scale-90">About us</button>
                </Link>
            </div>
        </React.Fragment>
    );
